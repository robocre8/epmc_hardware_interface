...
#ifndef EPMC_HARDWARE_INTERFACE
#define EPMC_HARDWARE_INTERFACE
...
{
  class EPMC_HardwareInterface : public hardware_interface::SystemInterface
  {
  ...
  public:
    RCLCPP_SHARED_PTR_DEFINITIONS(EPMC_HardwareInterface);
  ...
  private:
    ...
    float pos_cache_[2] = {0};
    float vel_cache_[2] = {0};

    // Cached command from ros2_control
    float cmd_cache_[2] = {0};
